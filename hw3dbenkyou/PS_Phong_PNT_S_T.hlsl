...
float4 main(float3 pixel_world_pos : POSITION, float3 n : NORMAL, float2 tex_cord : TEXTURE) : SV_TARGET
{
	...
	float specular_intensity = calc_specular_intensity(cam_pos, light_pos, light_specular_intensity, pixel_world_pos, n, obj_specular_intensity, obj_specular_power);
